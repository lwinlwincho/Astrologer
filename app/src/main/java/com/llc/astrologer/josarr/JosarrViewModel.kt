...
class JosarrViewModel : ViewModel() {
    ...
    val spnDayPosition: Int get() = _spnDayPosition

    var joSar = listOf<Int>(6, 15, 8, 17, 10, 19, 12, 21)

    private var _josarrList = mutableListOf<String>()
    val josarrList = _josarrList

    fun getJosarr(age: Int, position: Int): String {

        _spnDayPosition = position

        if (age > 0 && age <= joSar[_spnDayPosition]) {
            agePlus = joSar[_spnDayPosition]
        } else if (age > joSar[_spnDayPosition]) {
            agePlus = joSar[_spnDayPosition]
    ...
    private fun addJosarr() {
        ...
        _josarrList.add(
            "သင်သည် \"တနင်္ဂနွေ\" ဂြိုဟ်စား နေသဖြင့် ရွှေ၊ ငွေ၊ ဥစ္စာ အိမ်တွင်းရှိ ပစ္စည်းများ ကုန်ဆုံးခြင်း၊ အနာရောဂါ ဖြစ်ပွားခြင်း၊ ခိုက်ရန်ဒေါသ အငြင်းအခုန်ဖြစ်ရခြင်း၊ " +
                    "ကိုယ့်ထက်ကြီသော ဆရာမိဘ၏ သဘောကွဲ အထင်အမြင် လွဲခံရခြင်း၊ ကိုယ့်အောက်ကလူများ၊ ကျေးကျွန်များ တော်လှန်အာခံတတ်ခြင်း၊ " +
                    ...
                    "တနင်္ဂနွေနေ့၌ဖြစ်စေ၊ တနင်္ဂနွေထောင့်၌ဖြစ်စေ အုန်းဆွမ်း၊ အုန်းပင်၊ အုန်းလက်တို့ကို ကိုယ်တိုင်သွား၍ လှူဒါန်းပြီး လိုရာဆုမွန်ကိုတောင်းပါ။"
        )
        _josarrList.add(
        ...
        _josarrList.add(
            ("သင်သည် \"အင်္ဂါ\" ဂြိုဟ်စား နေသဖြင့် ချစ်သူမယား ကြင်ဖက် ရည်းစားများနှင့် သေကွဲ ရှင်ကွဲ ဖြစ်တတ်ပြီး" +
                    ...
                    "အရှေ့တောင်အရပ်သို့ ညအိပ်နေ၀◌င် မြစ်ကူးချောင်းခြား ခရီးေ၀◌း မသွားပါလေနှင့်၊ရှောင်ပါ။\n" + "\n" +
                    "သွားလျှင် ဧကန် ဘေးရန်တွေ့ပြီး ဓားလှံ ထိတတ်၊ သွေးထွက်သံယို ဖြစ်တတ်သည်။\n" + "\n" +
                    "အင်္ဂါနေ့မှာသော်လည်းကောင်း၊ အင်္ဂါအရပ်မှ ဘုရားစေတီ ဗောဓိညောင်ပင်မှာ သော်လည်းကောင်း" +
                    "ဆွမ်း၊ နှင်းဆီပန်း ကိုယ်တိုင် သွားရောက် လှူဒါန်းပြီး ဆုမွန်ကောင်းတောင်းယူပါ။")
        )
        _josarrList.add(
            ("သင်သည် \"ဗုဒ္ဓဟူး\" ဂြိုဟ်စား နေသဖြင့် အပျိုကညာ ရည်းစားများ၊ ကြင်ဖော်ကြင်ဖက်များနှင့် ဧကန် တွေ့ရကိန်းရှိသည်။\n" + "\n" +
                    "ရွှေ၊ ငွေ၊ ဥစ္စာ ၊ စုတ်ကောင်း၊ လာဘ်ကောင်း ၀◌င်မည်။\n" + "\n" +
                    "သောက ကင်းေ၀◌းပြီး၊ မျက်နှာပွင့်မည်။\n" + "\n" +
                    "အကြံအစည်အောင်ပြီး နာမည်ကောင်းရမည်။\n" + "\n" +
                    "တောင်အရပ်မှ အဖြူရောင် ရှိသည့် အ၀◌တ်အထည်နှင့် အခြားပစ္စည်း ၀◌င်ကိန်းရှိသည်။\n" + "\n" +
                    "ဗုဒ္ဓဟူးသားသမီးကသော်လည်းကောင်း၊ တရုတ်လူမျိုးများ ကသော်လည်းကောင်း အကြံအစည် အကူအညီပေး၍ စီးပွားတက်လိမ့်မည်။\n" + "\n" +
                    "ဗုဒ္ဓဟူးနေ့မှာ သော်လည်းကောင်း၊ ဗုဒ္ဓဟူးအရပ်မှာ သော်လည်းကောင်း" +
        ...
        _josarrList.add(
            ("သင်သည် \"စနေ\" ဂြိုဟ်စား နေသဖြင့် အနောက်တောင်အရပ်က ရန်ညှိုးဖွဲ့သူ မိန်းမ ယောက်ျားနှင့် ကြုံတွေ့ရတတ်သည်။\n" + "\n" +
                    "ဆွေမျိုး ညာတိ မိတ်ဆွေများကပင် အထင်မြင်သေးခြင်း၊ သဘောကွဲခြင်း၊ ရန်သူလုပ်ခြင်းကြောင့် စိတ်ဆင်းရဲ၊ ကိုယ်ဆင်းရဲ ဖြစ်ရကိန်း ရှိသည်။\n" + "\n" +
                    ...
                    "ဆွေမတော် မျိုးမစပ်သော စနေသားသမီးများ၊ အိမ်ထောင်ပျက် မိန်းမယောက်ျားများ၊ လင်သေမုဆိုးမများ၀◌င်လျှင် လက်မခံနှင့်၊ အမှုအခင်းဖြစ်ရတတ်သည်။\n" + "\n" +
                    ...
                    "စနေနေ့မှ သော်လည်းကောင်း၊ စနေအရပ်ကသော်လည်းကောင်း ဘုရားစေတီ၌ ထီးဖြူ၊ ထီးနီ၊ နာနတ်ပန်း၊ ဒေါနပန်းများကို ကိုယ်တိုင် သွား၍ လှူဒါန်းပြီး ဆုမွန်ကောင်း တောင်းယူရမည်။\n")
        )
        _josarrList.add(
            ("သင်သည် \"ကြာသပတေး\" ဂြိုဟ်စား နေသဖြင့် အနောက်အရပ်က ကြာသပတေး သားသမီးများ ချစ်ခင်ကြင်နာ၍ မ,စ ကူညီအံ့။\n" + "\n" +
                    ...
                    "မိတ်ကောင်းဆွေကောင်းများ၊ သူတော်ကောင်း ဆရာမိဘများ ချီးမြှင့်ထောက်ပံ့လာခြင်းကြောင့် ကြာသပတေးနံ ပိုးဖဲပိတ် စသော ပစ္စည်းများ ၀◌င်ကိန်းရှိသည်။\n" + "\n" +
                    ...
                    "အောင်သပြေပန်း၊ မေမြိုပန်း၊ ငှက်ပျောသီးများကို ကိုယ်တိုင်သွား၍ ဘုရားစေတီများ၌ လှူဒါန်းပူဇော်ကာ ဆုမွန်ကောင်း တောင်ယူရမည်။")
        )
        _josarrList.add(
            ("သင်သည် \"ရာဟု\" ဂြိုဟ်စား နေသဖြင့် ကိုယ်၌ ယားယံသော ၀◌ဲနာ၊ ပွေးနာ၊ အဖုအပိန့်များ စွဲကပ်အံ့။\n" + "\n" +
                    "နှလုံးမသာ၊ သေလုနီးပါး လေနာ၊ ရင်နာ၊ ၀◌မ်းဥပဒ် ဖြစ်တတ်သည်။\n" + "\n" +
                    "၀◌က်သားကိုရှောင်ပါ\n" + "\n" +
                    "ရွှေ၊ ငွေ၊ ဥစ္စာ စီးပွားရေး ဟူသမျှ ပျက်စီးကုန်ကျကိန်း ရှိသည်။\n" + "\n" +
                    "ရောဂါလည်း ထူတတ်သည်။ \n" + "\n" +
                    "ကျေးကျွန် ထွက်ပြေးတတ်သည်။\n" + "\n" +
                    "ကြွေးမြီး ဆုံးပါးတတ်သည်။ \n" + "\n" +
                    "အိမ်ခြေ မတည်ဖြစ်တတ်သည်။\n" + "\n" +
                    "အနောက်မြောက်အရပ်များသို့ ခရီးေ၀◌း မြစ်ကူး ချောင်းခြားမသွားကောင်း။\n" + "\n" +
        ...
        _josarrList.add(
            ("သင်သည် \"သောကြာ\" ဂြိုဟ်စား နေသဖြင့် မိမိ မမြင်ဖူးသော ကြင်ဖော်ကြင်ဖက်နှင့် တွေ့ရတတ်သည်။\n" + "\n" +
                    "မြောက်အရပ်က အဖြူရောင်ရှိသောအရာ ရွှေ၊ ငွေ၊ ဥစ္စာ၊ ကျေးကျွန်၊ ဆင်၊ မြင်း၊ စုတ်ကောင်း၊ လာဘ်ကောင်းများ ၀◌င်လာကိန်း ဧကန်ရှိသည်။\n" + "\n" +
                    "နောက်နောက်က မတွေ့မကြုံ မရရှိဖူးသေးသည့် လာဘ်ကောင်း၊ အ၀◌တ်အထည်ကောင်းများ၊ အခြေအနေများကို ရရှိခံစားရကိန်းရှိသည်။\n" + "\n" +
                    ...
                    "သောကြာနေ့မှာဖြစ်စေ၊ သောကြာအရပ်ကဖြစ်စေ သစ်သီး၊ ရေစင်ရေကောင်းများကို ဘုရားစေတီတော်သို့ ကိုယ်တိုင်သွားရောက်ပြီး လှူဒါန်း၍ ဆုမွန်ကောင်း တောင်းယူပါ။\n")
        )
    }
